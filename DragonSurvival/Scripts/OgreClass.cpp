...
OgreClass::OgreClass(sf::Vector2f position,sf::Vector2f newScreenSize)
{

	alive=true;
	aiState= AI::AIState::Wander;
	//sprites
	OgreAnimation[0]=sf::IntRect(400, 831, 100, 100 );
	OgreAnimation[1]=sf::IntRect( 0, 931, 100, 100 );
	OgreAnimation[2]=OgreAnimation[0];
	OgreAnimation[3]=sf::IntRect(100, 931, 100, 100 );
	...
	sprite.setTextureRect(OgreAnimation[AnimationNumber]);//piece of the sprite sheet
...
void OgreClass::Update(sf::Time DeltaTime)
{
...
void OgreClass::Wander(sf::Time DeltaTime)
{
...
void OgreClass::ChangeDirection()
{
...
void OgreClass::UpdateAnimation(sf::Time DeltaTime)
{
...
void  OgreClass::Draw(sf::RenderWindow* window)
{
...
std::vector<sf::FloatRect> OgreClass::GetCollision()
{
...
float OgreClass::HandleCollision(int ColliderNum,Sound::SoundEffect & sfx)
{
	sfx=Sound::NONE;
